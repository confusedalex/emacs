...
** Keybinds
#+begin_src emacs-lisp
(defvar-keymap prefix-quatsch-map
  :doc "mein prefix quatsch"
  "a" #'org-agenda)
...
(defvar-keymap spc-prefix-map
  ...
  "n" prefix-quatsch-map)

(which-key-add-keymap-based-replacements spc-prefix-map
  "n" `("eins zwei drei" . ,prefix-quatsch-map)
...
(use-package evil
  ...
  (evil-define-key 'normal 'global (kbd "<leader> f c") '(lambda() (interactive)(find-file "~/.emacs.d/config.org")))
  ...
  ;; Compute
  (evil-define-key 'normal 'global (kbd "<leader> c r") 'elisp-eval-region-or-buffer) ;; Reload config
  ...
  (evil-define-key 'normal 'global (kbd "<leader> o n") '(lambda() (interactive)(find-file "~/persist/org/notes.org")))
  (evil-define-key 'normal 'global (kbd "<leader> o j") '(lambda() (interactive)(find-file "~/persist/org/journal.org")))
  (evil-define-key 'normal 'global (kbd "<leader> o w") '(lambda() (interactive)(find-file "~/persist/org/work.org")))
  (evil-define-key 'normal 'global (kbd "<leader> o b") '(lambda() (interactive)(find-file "~/persist/org/books.org")))
  (evil-define-key 'normal 'global (kbd "<leader> o i") '(lambda() (interactive)(find-file "~/persist/org/inbox.org")))

  ;; Org mode things
  (evil-define-key 'normal 'global (kbd "<leader> o a") 'org-agenda)
  (evil-define-key 'normal 'global (kbd "<leader> o c") 'org-capture)
  (evil-define-key 'normal 'global (kbd "<leader> m e") 'org-export-dispatch)

  ;; Org tables
  (evil-define-key 'normal 'global (kbd "<leader> m b d c") 'org-table-delete-column)
  (evil-define-key 'normal 'global (kbd "<leader> m b d r") 'org-table-delete-row)

  ;; Org dates
  (evil-define-key 'normal 'global (kbd "<leader> m d d") 'org-deadline)
  (evil-define-key 'normal 'global (kbd "<leader> m d s") 'org-schedule)
  (evil-define-key 'normal 'global (kbd "<leader> m d t") 'org-time-stamp)
  (evil-define-key 'normal 'global (kbd "<leader> m d T") 'org-time-stamp-inactive)

  ;; Org subtree
  (evil-define-key 'normal 'global (kbd "<leader> m s n") 'org-narrow-to-subtree)
  (evil-define-key 'normal 'global (kbd "<leader> m s N") 'widen)
  (evil-define-key 'normal 'global (kbd "<leader> m s r") 'org-refile)
  (evil-define-key 'normal 'global (kbd "<leader> m s S") 'org-sort)
...
(use-package org-super-agenda
  ...
  (org-agenda-custom-commands
   '(("p" "private"
	 ...
	 ("g" "gifts"
	  ((todo-tags "+gifts" ((org-agenda-overriding-header "")
						   ;; (org-super-agenda-groups
						   ;;  '((:name "Important"
						   ;; 		     :tag "Important"
						   ;; 		     :priority "A"
